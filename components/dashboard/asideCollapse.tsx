...
export default function AsideCollapse(): JSX.Element {
  return (
    <aside className="hidden md:flex fixed top-0 left-0 z-40 flex-none flex-col w-16 h-screen px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-800 dark:border-gray-700">
