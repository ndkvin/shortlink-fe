    ...
    <>
      <div className="w-full h-full bg-gray-200">
        <div className="flex flex-no-wrap">
          {/* Sidebar starts */}
          <div className="absolute lg:relative w-64 h-screen shadow bg-gray-100 hidden lg:block dark:bg-slate-900">
          ...
          <div className={show ? "w-full h-full absolute z-40  transform  translate-x-0 dark:bg-slate-900" : "   w-full h-full absolute z-40  transform -translate-x-full dark:bg-slate-900"} id="mobile-nav">
            ...
            <div className="absolute z-40 sm:relative w-64 md:w-96 shadow pb-4 bg-gray-100 lg:hidden transition duration-150 ease-in-out h-full">
              <div className="flex flex-col justify-between h-full w-full dark:bg-slate-800">
                <div>
          ...
          <div className="w-full dark:bg-gray-800 dark:border-gray-700">
            {/* Navigation starts */}
            <nav className="h-16 dark:bg-gray-800 dark:border-gray-700 flex items-center lg:items-stretch justify-end lg:justify-between bg-white shadow relative z-10">
              <div className="hidden lg:flex w-full pr-6 dark:bg-slate-800">
              ...
              <div className="text-gray-600 mr-8 visible lg:hidden relative dark:bg-slate-800" onClick={() => setShow(!show)}>
                {show ? (
                  " "
                ) : (
            ...
            <div className="container mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6 dark:bg-gray-800 dark:border-gray-700">
