      ...
      <nav className="z-10 sticky top-0 bg-white shadow dark:bg-gray-800">
        <div className="container px-6 py-4 mx-auto">
          <div className="lg:flex lg:items-center lg:justify-between">
            ...
            <div className={open ? 'px-4 absolute inset-x-0 z-20 w-full py-4 transition-all duration-300 ease-in-out bg-white dark:bg-gray-800 lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:bg-transparent lg:w-auto lg:opacity-100 lg:translate-x-0 lg:flex lg:items-center' : 'px-4 absolute inset-x-0 z-20 w-full py-4 transition-all duration-300 ease-in-out bg-white dark:bg-gray-800 lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:bg-transparent lg:w-auto lg:opacity-100 lg:translate-x-0 lg:flex lg:items-center hidden'}>
                  ...
                  isLogin ?
                    <>
                      <div className="relative flex">
                        ...
                        <div
                          className={dropdownOpen ? "absolute z-20 w-48 py-2 mt-12 origin-top-right bg-white rounded-md shadow-xl dark:bg-gray-800" : "absolute  z-20 w-48 py-2 mt-11 origin-top-right bg-white rounded-md shadow-xl dark:bg-gray-800 hidden"}
                        >
                          ...
                          <button onClick={logout} type="button" className="w-full flex items-center p-3 text-sm text-gray-600 capitalize transition-colors duration-300 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
                            <svg className="w-5 h-5 mx-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
